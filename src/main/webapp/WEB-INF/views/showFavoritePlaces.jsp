...
<title>User's favorite places</title>
</head>
<body style="background-color: grey">
	...
	<section class="page-section bg-light" id="portfolio">
		<h1 style="text-align: center">User's favorite places</h1>
		<div class="container">
			<div class="row">
				<c:forEach items="${sessionScope.favoritePlaces }"
					var="currentPlace">
					<div class="col-lg-4 col-sm-6 mb-4">
						...
						<div class="portfolio-item">
							...
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted"><a href="deleteFavoritePlace?placeId=${ currentPlace.id}">delete</a> </div>
							</div>
						</div>
					</div>
				</c:forEach>
